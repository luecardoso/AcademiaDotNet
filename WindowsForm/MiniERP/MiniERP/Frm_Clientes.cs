...
namespace MiniERP
{
    public partial class Frm_Clientes : Form
    {
        ...
        private void atualizar()
        {
            ...
            {
                //textBox_Nome.Text = dataGridView_Clientes.CurrentCell.Value.ToString();
                //textBox_Nome.Text = dataGridView_Clientes.CurrentCell.ColumnIndex.ToString();
                //textBox_Nome.Text = dataGridView_Clientes.SelectedColumns[1].ToString();
                //textBox_Nome.Text = dataGridView_Clientes.CurrentRow.DataBoundItem.ToString();
            }
